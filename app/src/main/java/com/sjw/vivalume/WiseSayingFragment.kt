 ...
 * Use the [WiseSayingFragment.newInstance] factory method to
...
class WiseSayingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        with(binding) {
            ...
            wiseSayings?.let {
                ...
                wiseSayingText.text = randomWiseSaying.wiseSaying
                 Glide.with(bgImg)
    ...
    companion object {
         ...
         * @return A new instance of fragment WiseSayingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WiseSayingFragment().apply {
